...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 140 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.programstruct) = new Program((yyvsp[-2].program_Head)->m_Id, (yyvsp[-2].program_Head)->m_Id_List, (yyvsp[-1].program_Body));
...
#line 1499 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 3:
#line 146 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		tmp -> m_name = *((yyvsp[-4].m_str));
		tmp -> m_lineno = yylineno;
		tmp -> m_idType = TYPE_ID;
		(yyval.program_Head) = new ProgramHead(tmp, (yyvsp[-2].id_List));
	}
#line 1511 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 153 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.program_Head) = new ProgramHead(nullptr,nullptr);
	}
#line 1519 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 156 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.program_Head) = new ProgramHead(nullptr,nullptr);
	}
#line 1527 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 161 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.program_Body) = new ProgramBody((yyvsp[-3].const_Declarations), (yyvsp[-2].var_Declarations), (yyvsp[-1].subProgram_Declarations), (yyvsp[0].compound_Statement));
	}
#line 1535 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 165 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.program_Body) = new ProgramBody();
	}
#line 1543 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 170 "p2c.y" /* yacc.c:1646  */
    {
...
#line 1569 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 194 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.const_Declarations) = new ConstDeclarations((yyvsp[-1].const_Declaration) -> mv_Const);
	}
#line 1577 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 197 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.const_Declarations) = new ConstDeclarations();
	}
#line 1585 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 203 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		...
		(yyval.const_Declaration) = new ConstDeclaration((yyvsp[-4].const_Declaration) -> mv_Const);
	}
#line 1598 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 211 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		tmp -> m_name = *((yyvsp[-2].m_str));
		tmp -> m_lineno = yylineno;
		(yyval.const_Declaration) = new ConstDeclaration();
...
#line 1610 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 14:
#line 221 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.const_Value) = new ConstValue();
		(yyval.const_Value) -> m_lineno = yylineno;
		(yyval.const_Value) -> m_postNeg = CONST_POSITIVE;
...
#line 1626 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 15:
#line 232 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.const_Value) = new ConstValue();
		(yyval.const_Value) -> m_lineno = yylineno;
		(yyval.const_Value) -> m_postNeg = CONST_NEGATIVE;
		(yyval.const_Value) -> m_valueType = TYPE_ID;
		(yyval.const_Value) -> m_isId = true;
		Id* tmp = new Id();
		tmp -> m_name = *((yyvsp[0].m_str));
...
#line 1691 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 20:
#line 272 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.const_Value) = new ConstValue();
		(yyval.const_Value) -> m_postNeg = CONST_POSITIVE;
		(yyval.const_Value) -> m_valueType = TYPE_INTEGER;
...
#line 1724 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 23:
#line 290 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.const_Value) = new ConstValue();
		(yyval.const_Value) -> m_postNeg = CONST_NULL;
...
#line 1746 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 25:
#line 304 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.var_Declarations) = new VarDeclarations((yyvsp[-1].var_Declaration) -> mv_Var);
	}
#line 1754 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 307 "p2c.y" /* yacc.c:1646  */
    {
		vector<p_Var> tmp;
		(yyval.var_Declarations) = new VarDeclarations(tmp);
	}
#line 1763 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 314 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.var_Declaration) = new VarDeclaration((yyvsp[-4].var_Declaration) -> mv_Var);
...
#line 1772 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 28:
#line 318 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.var_Declaration) = new VarDeclaration();
		(yyval.var_Declaration) -> mv_Var.push_back(p_Var((yyvsp[-2].id_List), (yyvsp[0].type)));
	}
...
#line 1886 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 41:
#line 386 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.subProgram_Declarations) = new SubProgramDeclarations((yyvsp[-2].subProgram_Declarations) -> mv_Common);
...
#line 1895 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 42:
#line 390 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.subProgram_Declarations) = new SubProgramDeclarations();
	}
#line 1903 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 396 "p2c.y" /* yacc.c:1646  */
    {
...
#line 1916 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 44:
#line 406 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		tmp -> m_name = *((yyvsp[-4].m_str));
		tmp -> m_lineno = yylineno;
		(yyval.subprogram_Head) = new SubprogramHead(tmp, (yyvsp[-3].formal_Parameter), (yyvsp[-1].m_int));
	}
#line 1927 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 412 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		tmp -> m_name = *((yyvsp[-2].m_str));
		tmp -> m_lineno = yylineno;
		(yyval.subprogram_Head) = new SubprogramHead(tmp, (yyvsp[-1].formal_Parameter), TYPE_NULL);
	}
#line 1938 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 418 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		(yyval.subprogram_Head) = new SubprogramHead(tmp,new FormalParameter(),TYPE_NULL);
	}
#line 1947 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 422 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		(yyval.subprogram_Head) = new SubprogramHead(tmp,new FormalParameter(),TYPE_NULL);
	}
#line 1956 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 48:
#line 429 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.formal_Parameter) = new FormalParameter((yyvsp[-1].parameter_List));
	}
#line 1964 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 49:
#line 432 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.formal_Parameter) = new FormalParameter(nullptr);
	}
#line 1972 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 438 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.parameter_List) = new ParameterList(yylineno, (yyvsp[-2].parameter_List) -> mv_Patameter);
...
#line 2010 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 54:
#line 462 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.var_Parameter) = new VarParameter((yyvsp[0].value_Parameter));
	}
#line 2018 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 55:
#line 468 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.value_Parameter) = new ValueParameter((yyvsp[-2].id_List), (yyvsp[0].m_int));
	}
#line 2026 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 56:
#line 474 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.subprogram_Body) = new SubprogramBody((yyvsp[-2].const_Declarations), (yyvsp[-1].var_Declarations), (yyvsp[0].compound_Statement));
	}
#line 2034 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 57:
#line 477 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.subprogram_Body) = new SubprogramBody(nullptr,nullptr,new CompoundStatement());
	}
#line 2042 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 58:
#line 482 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.compound_Statement) = new CompoundStatement((yyvsp[-1].statement_List));
	}
#line 2050 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 59:
#line 488 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.statement_List) = new StatementList((yyvsp[-2].statement_List) -> mv_Statement);
...
#line 578 "p2c.y" /* yacc.c:1646  */
    {
		...
		if((yyvsp[0].id_Varpart) -> m_Expression_List != nullptr){
...
#line 2217 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 73:
#line 597 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.id_Varpart) = new IdVarPart((yyvsp[-1].expression_List));
	}
#line 2225 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 74:
#line 600 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.id_Varpart) = new IdVarPart(nullptr);
	}
#line 2233 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 75:
#line 606 "p2c.y" /* yacc.c:1646  */
    {
		Id* tmp = new Id();
		tmp -> m_name = *((yyvsp[0].m_str));
		tmp -> m_lineno = yylineno;
		(yyval.procedure_Call) = new ProcedureCall();
		(yyval.procedure_Call) -> m_lineno = yylineno;
		(yyval.procedure_Call) -> m_expNum = 0;
		(yyval.procedure_Call) -> mp_Id = tmp;
		(yyval.procedure_Call) -> mp_Expression_List = nullptr;
...
#line 2280 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 79:
#line 641 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression_List) = new ExpressionList((yyvsp[-2].expression_List) -> mv_Expression, (yyvsp[-2].expression_List) -> mv_Type);
...
#line 2289 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 80:
#line 645 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression_List) = new ExpressionList();
		(yyval.expression_List) -> mv_Expression.push_back((yyvsp[0].expression));
	}
#line 2298 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 81:
#line 652 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression) = new Expression();
		(yyval.expression) -> m_lineno = yylineno;
		(yyval.expression) -> mp_Simple_Expression = nullptr;
		(yyval.expression) -> mp_Relop = new RelOp(LARGER, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].simple_Expression));
	}
#line 2309 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 82:
#line 658 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression) = new Expression();
		(yyval.expression) -> m_lineno = yylineno;
		(yyval.expression) -> mp_Simple_Expression = nullptr;
		(yyval.expression) -> mp_Relop = new RelOp(LESS, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].simple_Expression));
	}
#line 2320 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 83:
#line 664 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression) = new Expression();
		(yyval.expression) -> m_lineno = yylineno;
		(yyval.expression) -> mp_Simple_Expression = nullptr;
		(yyval.expression) -> mp_Relop = new RelOp(NOT_EQUAL, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].simple_Expression));
	}
#line 2331 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 84:
#line 670 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression) = new Expression();
		(yyval.expression) -> m_lineno = yylineno;
		(yyval.expression) -> mp_Simple_Expression = nullptr;
		(yyval.expression) -> mp_Relop = new RelOp(LESS_EQUAL, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].simple_Expression));
	}
#line 2342 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 85:
#line 676 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression) = new Expression();
		(yyval.expression) -> m_lineno = yylineno;
		(yyval.expression) -> mp_Simple_Expression = nullptr;
		(yyval.expression) -> mp_Relop = new RelOp(LARGER_EQUAL, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].simple_Expression));
	}
#line 2353 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 86:
#line 682 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression) = new Expression();
		(yyval.expression) -> m_lineno = yylineno;
		(yyval.expression) -> mp_Simple_Expression = nullptr;
		(yyval.expression) -> mp_Relop = new RelOp(EQUAL, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].simple_Expression));
	}
#line 2364 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 87:
#line 688 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.expression) = new Expression();
		(yyval.expression) -> m_lineno = yylineno;
...
#line 2375 "pasc.tab.c" /* yacc.c:1646  */
  ...
  case 88:
#line 697 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.simple_Expression) = new SimpleExpression(yylineno, nullptr, (yyvsp[0].term));
	}
#line 2383 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 89:
#line 700 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.simple_Expression) = new SimpleExpression(yylineno, new AddOp(ADD, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].term)),nullptr);
	}
#line 2391 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 90:
#line 703 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.simple_Expression) = new SimpleExpression(yylineno, new AddOp(SUB, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].term)),nullptr);
	}
#line 2399 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 91:
#line 706 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.simple_Expression) = new SimpleExpression(yylineno, new AddOp(OR, yylineno, (yyvsp[-2].simple_Expression), (yyvsp[0].term)),nullptr);
	}
#line 2407 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 92:
#line 712 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.term) = new Term(yylineno, new MulOp(MULTIPLY, yylineno, (yyvsp[-2].term), (yyvsp[0].factor)), nullptr);
	}
#line 2415 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 93:
#line 715 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.term) = new Term(yylineno, new MulOp(REAL_DIV, yylineno, (yyvsp[-2].term), (yyvsp[0].factor)), nullptr);
	}
#line 2423 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 94:
#line 718 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.term) = new Term(yylineno, new MulOp(AND, yylineno, (yyvsp[-2].term), (yyvsp[0].factor)), nullptr);
	}
#line 2431 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 95:
#line 721 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.term) = new Term(yylineno, new MulOp(INT_DIV, yylineno, (yyvsp[-2].term), (yyvsp[0].factor)), nullptr);
	}
#line 2439 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 96:
#line 724 "p2c.y" /* yacc.c:1646  */
    {
		(yyval.term) = new Term(yylineno, new MulOp(MOD, yylineno, (yyvsp[-2].term), (yyvsp[0].factor)), nullptr);
	}
#line 2447 "pasc.tab.c" /* yacc.c:1646  */
    break;

  case 97:
#line 727 "p2c.y" /* yacc.c:1646  */
    {
...
#line 774 "p2c.y" /* yacc.c:1646  */
    {
		...
		tmp -> m_name = *((yyvsp[-3].m_str));
		tmp -> m_lineno = yylineno;
		(yyval.factor) -> mp_Function_Call = new FunctionCall((yyvsp[-1].expression_List) -> mv_Expression.size(), yylineno, tmp, (yyvsp[-1].expression_List));
		(yyval.factor) -> mp_Expression = nullptr;
		(yyval.factor) -> mp_Not = nullptr;
		(yyval.factor) -> mp_Uminus = nullptr;
